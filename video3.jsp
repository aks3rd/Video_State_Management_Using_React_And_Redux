...
<div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Video 3</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        
                        <ol class="breadcrumb">
                            <li><a>Dashboard</a></li>
                            <li class="active">Video 3</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <!-- .col -->
                    <div class="col-md-12 col-lg-8 col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Style Three</h3><hr/>
                            <video id="video1" width="100%" controls>
                               <source src="videos/stylethree.mp4" type='video/webm; codecs="vp8.0, vorbis"'>
                               <source src="videos/stylethree.mp4" type='video/ogg; codecs="theora, vorbis"'>
                               <source src="videos/stylethree.mp4" type=video/mp4>
                            </video>
                        </div>
                    </div>
